...
import com.example.project.ai.client.StudentAIChat;
...
public class StudentChatController {
    ...
    @Autowired
    private StudentAIChat studentAIChat;
    ...
    public SseEmitter chat(@RequestAttribute("userId") String jwtSubject,
        ...
        Disposable subscription = studentAIChat.stream(timeId, message, jwtSubject)
                .subscribe(chunk -> {
